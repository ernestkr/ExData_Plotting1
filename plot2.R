...
## It will then draw the fluctuation of Global Active Power over time.
########################################################################################################################
...
## Draw the figure, which in this case the value of Global Sctive Power over time
plot(MySelectDF$Global_active_power,type='l', xlab='', ylab='Global Active Power (kilowatts)', main='', xaxt='n')
