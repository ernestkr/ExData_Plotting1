...
## It will then draw four sub plots corresonding to Global Active Power, Voltage, Energy sub metering, and global reactive power.
#################################################################################################################################
...
## Draw the figure, which consists of the four sub figures
par(mfrow=c(2,2))
## The first subfigure is for the Global Active Power
plot(MySelectDF$Global_active_power,type='l', xlab='', ylab='Global Active Power', main='', xaxt='n')
## Update the plot to include the x axis just created
axis(side=1, at=LTicks, labels=LLabel)
## The second subfigure is for the Voltage
plot(MySelectDF$Voltage, type='l', xlab='datetime', ylab='Voltage', main='', xaxt='n')
## Update the plot to include the x axis just created
axis(side=1, at=LTicks, labels=LLabel)
## The third subfigure is for the Energy Sub Metering
...
## Update the plot to include the x axis just created
axis(side=1, at=LTicks, labels=LLabel)
## The fourth subfigure is for the Global Reactive Power
plot(MySelectDF$Global_reactive_power, type='l', xlab='datetime', ylab='Global_reactive_power', main='', xaxt='n')
## Update the plot to include the x axis just created
axis(side=1, at=LTicks, labels=LLabel)
